...
DECLARE @produto char(12), @codigo_filial varchar(06)
set @produto = '".$produto."'
set @codigo_filial = '".$loja."'

SET NOCOUNT ON EXEC dbo.LX_POLYELLE_ESTOQUE_PRODUTO_GRADE_AGRUPADA @produto, @codigo_filial
